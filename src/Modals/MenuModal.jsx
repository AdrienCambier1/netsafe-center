  ...
  return (
    <>
      ...
      <div
        ...
        } p-4 top-0 right-0 w-60 h-full fixed border-l border-transparent dark:border-zinc-800 dark:bg-zinc-950 bg-white transition-all ease-in-out block lg:hidden overflow-y-auto`}
      >
