...
export default function ToolsCard({ brand, title }) {
  return (
    <div className="dark:bg-zinc-900 bg-white rounded-xl w-full border dark:border-zinc-700 border-gray-300/50 p-2 dark:hover:border-purple-500 hover:border-purple-500 cursor-pointer flex gap-4 items-center">
