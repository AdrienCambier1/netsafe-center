...
export default function ToolsCard({ brand, title }) {
  return (
    <div className="dark:bg-zinc-950 bg-white rounded-xl w-full border dark:border-zinc-800 border-zinc-200 p-2 dark:hover:border-purple-500 hover:border-purple-500 cursor-pointer flex gap-4 items-center">
