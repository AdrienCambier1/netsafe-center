...
export default function ClassCard({ title, link }) {
  ...
  return (
    <div className="dark:bg-neutral-950 bg-white rounded-xl p-2 border border-transparent dark:border-neutral-800 dark:shadow-none shadow-md shadow-gray-200/50">
