export default function HalfWhiteCard({ image, children }) {
  return (
    <div className="dark:bg-zinc-900 bg-white border dark:border-zinc-700 border-transparent rounded-xl dark:shadow-none shadow-md shadow-gray-200/50 flex overflow-hidden h-fit max-h-full w-full md:w-fit">
