...
export default function HeavyPurpleButton({ link, onClick, icon, value }) {
  return (
    <a
      ...
      } text-white bg-purple-500 hover:bg-purple-600 hover:shadow-purple-600/50 shadow-md shadow-purple-500/50 rounded-xl cursor-pointer transition-all ease-in-out`}
    >
      <FontAwesomeIcon
