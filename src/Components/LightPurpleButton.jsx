...
export default function LightPurpleButton({ link, onClick, icon, value }) {
  return (
    <a
      href={link}
      onClick={onClick}
      className="group p-2.5 flex gap-2 items-center hover:bg-white w-full h-fit rounded-xl hover:shadow-md hover:shadow-purple-200/50 transition-all ease-in-out"
    >
      <FontAwesomeIcon
