...
export default function LightRedButton({ link, onClick, icon, value }) {
  return (
    <Link
      to={link}
      onClick={onClick}
      className="group p-2.5 flex gap-2 items-center dark:hover:bg-zinc-900 hover:bg-white w-full h-fit rounded-xl  dark:hover:shadow-none hover:shadow-md hover:shadow-gray-200/50 cursor-pointer"
    >
      <FontAwesomeIcon
