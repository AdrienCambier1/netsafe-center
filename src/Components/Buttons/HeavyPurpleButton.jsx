...
export default function HeavyPurpleButton({ link, onClick, icon, value }) {
  return (
    <Link
      ...
      } min-h-10 text-white dark:bg-purple-700 bg-purple-500 dark:hover:bg-purple-800 hover:bg-purple-600 dark:hover:shadow-purple-800/50 hover:shadow-purple-600/50 shadow-md dark:shadow-purple-700/50 shadow-purple-500/50 rounded-xl cursor-pointer`}
    >
      <FontAwesomeIcon
