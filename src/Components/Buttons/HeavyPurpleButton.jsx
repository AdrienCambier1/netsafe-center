...
export default function HeavyPurpleButton({ link, onClick, icon, value }) {
  return (
    <Link
      ...
      } text-white bg-purple-500 dark:hover:bg-purple-400 hover:bg-purple-600 hover:shadow-purple-600/50 shadow-md shadow-purple-500/50 rounded-xl cursor-pointer`}
    >
      <FontAwesomeIcon
        className={`${
