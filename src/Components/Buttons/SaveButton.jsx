...
export default function SaveButton({ link, onClick, connectionRequired }) {
  ...
  return (
    <Link
      ...
      onClick={handleClick}
      className="gray-btn-bg dark:hover:bg-indigo-900/50 hover:bg-indigo-50 flex items-center justify-center dark:text-neutral-600 text-neutral-400 hover:text-indigo-500 dark:hover:text-indigo-500 rounded-full cursor-pointer"
    >
