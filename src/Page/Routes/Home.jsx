  ...
  return (
    <>
      <div className="min-h-screen w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative">
        <div className="col-span-1 px-4 sm:px-8 py-8">
        ...
        <div className="lg:col-span-2 relative flex flex-col gap-4 px-4 sm:px-8 py-8 md:border-l border-t md:border-t-0 border-color">
          {isLoading ? (
            <>
              <PostHeaderCardSkeleton />
              <NewsCardSkeleton />
        ...
        <div className="block md:hidden lg:block col-span-1 px-4 sm:px-8 py-8 lg:border-l border-t md:border-t-0 border-color">
          <div className="flex flex-col gap-8 sticky top-24">
            {asideElement()}
          </div>
        </div>
